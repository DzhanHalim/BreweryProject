...
namespace Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public JwtHelper(IConfiguration configuration)
        {
            ...
            // get the section of TokenOptions from appsettings.json and bind them   with the TokenOptions class entities(json to class)
            var json = Configuration.GetSection("TokenOptions").Value;
            _tokenOptions = JsonConvert.DeserializeObject<TokenOptions>(json);
